      ...
      ifNode(
        ...
        [
            ...
            ? state({
                procedure: [
                  toolbar.hideColumns
                    ...
                    : null,
                  toolbar.filter ? scalar(`filter_dialog_open`, `false`) : null,
                ...
                when (select count(*) from column where not displaying) = 1 then '1 hidden column'
                          ...
                          startDecorator: materialIcon("VisibilityOffOutlined"),
                          on: {
                            click: [
                              toolbar.filter
                              ...
                              toolbar.sort
                                ...
                                : null,
                              setScalar(`ui.columns_dialog_open`, `true`),
                              stopPropagation(),
                            ],
                          },
                        }),
                        ...
                        button({
                          ...
                          on: {
                            click: [
                              ...
                              setScalar(`ui.sort_dialog_open`, `false`),
                              setScalar(`ui.filter_dialog_open`, `true`),
                              stopPropagation(),
                            ],
                          },
                        }),
                ...
                when (select count(*) from column where sort_index is not null) = 1 then 'Sorted by 1 field'
                          ...
                          on: {
                            click: [
                              setScalar(`ui.filter_dialog_open`, `false`),
                              setScalar(`ui.columns_dialog_open`, `false`),
                              setScalar(`ui.sort_dialog_open`, `true`),
                              stopPropagation(),
                            ],
                          },
                        }),
          ...
          select({
            ...
            on: {
              change: [setScalar(`row_height`, `cast(target_value as bigint)`)],
            },
            children: [
              element("option", {
                props: { value: `44` },
