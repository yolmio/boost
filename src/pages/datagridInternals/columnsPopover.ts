    ...
    children: [
      ...
      nodes.element("div", {
        ...
        children: nodes.each({
          table: "column",
          orderBy: "ordering",
          where: `fn.${dts.idToColumnsDisplayName}(id) is not null and (trim(filter_text) = '' or fn.${dts.idToColumnsDisplayName}(id) like '%' || filter_text || '%')`,
          key: "id",
          ...
          children: checkbox({
            ...
            label: `fn.${dts.idToColumnsDisplayName}(column_record.id)`,
            on: {
              click: (s) =>
                s
                  .if(
